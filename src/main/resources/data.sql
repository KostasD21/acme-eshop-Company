...
INSERT INTO category (id, name, description) VALUES (5, 'Desktop PC', 'Category for Desktop PCs');
INSERT INTO category (id, name, description) VALUES (6, 'Laptop', 'Category for Laptops');
INSERT INTO category (id, name, description) VALUES (7, 'Tablet', 'Category for Tablets');
INSERT INTO category (id, name, description) VALUES (8, 'Smart Phone', 'Category for Smartphones');
INSERT INTO category (id, name, description) VALUES (9, 'TV', 'Category for TVs');



INSERT INTO product (id, title, short_description, long_description, product_code,quantity, stock, availability, price) VALUES (6, 'Acer Aspire X', 'Normal laptop','Nvidia GTX 555','product Code 555', 3,10, 1, 800);
